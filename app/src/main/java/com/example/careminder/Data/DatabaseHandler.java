...
//                + Constants.KEY_CALORIES+ " INT," + Constants.KEY_NOTE + " LONG" + ")";
//
...
//                        Constants.KEY_CALORIES, Constants.KEY_NOTE},
//              );
...
//                //set food calories
//                food.setCalories(cursor.getDouble(cursor.getColumnIndex(Constants.KEY_CALORIES)));
//                //set food record date, convert to readable format
//                DateFormat dateFormat = DateFormat.getDateInstance();
//                food.setNote(dateFormat.format(cursor.getColumnIndex(Constants.KEY_NOTE)));
